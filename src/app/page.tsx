    ...
    <div className="min-h-screen bg-[#08080c] text-white overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-5 max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-lg tracking-tight">tranzmit</span>
        </div>

        <div className="flex items-center gap-3">
          <Link href="/sign-in" className="px-4 py-2 text-sm text-white/60 hover:text-white transition-colors">
            Login
          </Link>
          <Link href="/sign-up" className="group relative px-5 py-2.5 text-sm font-medium">
