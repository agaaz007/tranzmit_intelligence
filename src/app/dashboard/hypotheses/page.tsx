                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        conv.source === 'elevenlabs' || conv.source === 'AI PM Agent' ? 'bg-violet-500/10' : 'bg-[var(--brand-light)]'
                      }`}>
            ...
            <div className="sticky top-0 bg-[var(--card)] border-b border-[var(--border)] px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  selectedConversation?.source === 'elevenlabs' || selectedConversation?.source === 'AI PM Agent' ? 'bg-violet-500/10' : 'bg-[var(--brand-light)]'
                }`}>
